...
\end{align}
Dado a la potencia RMS que disipa y la tensión que debe manejar se eligió un TIP41C, el cual puede manejar este trabajo sin disipador.
...
\end{align}
Este transistor todavia se encuentra dentro de la potencia que puede disipar sin disipador.
