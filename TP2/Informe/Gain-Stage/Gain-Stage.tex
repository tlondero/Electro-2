...
Esta resistencia es de especial importancia dado que controla el nivel de continua sobre la carga, por lo que se optó por utilizar un trimmer para poder compensar el circuito para el caso de que haya variación en los componentes.
