...
Para el caso de $C_{Dom}$ se eligió un valor tal que las altas frecuencias vean una impedancia baja comparada con la entrada del emisor comun, cosa de que ``ignore'' la etapa de ganancia.\\
...
Como última consideración se optó por poner 3 etapas amplificadoras como la de la figura (\ref{fig:ec1}) previo al diseño (\ref{fig:ec3}) con la intención de aumentar la ganancia del bloque A tal valga la aproximación del parámetro estabilizante  a $\frac{1}{\beta}$ 
%\begin{align}
%\end{align}
\end{document}