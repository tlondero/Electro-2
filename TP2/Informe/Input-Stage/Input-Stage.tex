...
\begin{figure}[H]
\centering
	\includegraphics[width=0.8\textwidth, trim = {0 0 0 20},clip]{ImagenesInput-Stage/thd1.PNG}
...
\begin{figure}[H]
\centering
	\includegraphics[width=0.8\textwidth, trim = {0 0 0 20},clip]{ImagenesInput-Stage/thd2.PNG}
	\caption{THD en función de la frecuencia al variar el balance de la corriente del colector. Número de curva y distorsión especificadas en la Tabla (\ref{tab:thd2}).}
	\label{fig:thd2}
\end{figure}
