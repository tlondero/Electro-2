...
%Una ventaja que se presenta en este diseño es la posibilidad de colocar un control de volumen en esta instancia, implementando un filtro Sallen Key y colocando un potenciometro en la resistencia HAY QUE PONER BIEN EL CIRCUITO % $R_{90}$ (o 4R_{91}$) (capo, fijate cuales están en el spice no sé)
