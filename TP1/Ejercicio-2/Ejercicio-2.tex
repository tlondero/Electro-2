...
Finalmente para $V_2$ se fijó un valor que sea levemente mayor a la $V_z$ del diodo elegido, tal que con el valor de resistencia $R_Z$ elegido se encuentre polarizado correctamente, por lo que se fijó $V_2=7\ V$.
