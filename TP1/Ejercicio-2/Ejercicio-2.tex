...
donde $\alpha$ es la respuesta a lazo abierto, $f$ la respuesta del lazo realimentador y $T$ es la ganancia de lazo. Se puede observar que si la ganancia de lazo es mucho mayor a la unidad en módulo, entonces se tiene que 
